...
contract Synthetix {
    ...
    fallback() external {
        ...
        ) implementation = 0xcdA522f72aC0Ab675f9d9b27686229B9EE60F064;
        else if (
            msg.sig == 0xd72e0705 || // getOracleType()
            msg.sig == 0xe6dbd15d || // setOracleType()
            msg.sig == 0x10916f3b    // getVersionViaExchanger()
        ) implementation = 0x26a79B946C58fDa1b23a2E88bFEfA7E2a8F7DAf8;
        else if (
            msg.sig == 0xe017bb0d    // getSystemVersion()
        ) implementation = 0x1f0A572FF4B2850D747be740728E7CBCE17755e9;
