...
|           0x00000009      73bebebebebe.  push20 0xbebebebe     0xbebe 0 cds 0 0 0       Pushes implementation address to the stack
|           0x0000001e      5a             gas                   gas 0xbebe 0 cds 0 0 0.  Pushes available gas to the stack
...
contract MinimalProxy {
    constructor(address implementation) {
        ...
        assembly {
            ...
            // 363d3d373d3d3d363d73bebebebebebebebebebebebebebebebebebebebe5af43d82803e903d91602b57fd5bf3
            // ^                   ^                                       ^                             ^
            // First chunk         Implementation address                  Second chunk                  End
            // 0                   10                                      30                            45
            // 0x00                0x0a                                    0x1e                          0x2d
            ...
            // Write the implementation address at pos 10, or 0x0a
